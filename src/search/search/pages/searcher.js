          ...
          {results.length > 0 ? (
            results.map((item, index) => (
              <li key={index} style={{ marginBottom: '10px' }}>
                ...
                <br />
                <span>Species: {item.species || 'Unknown'}</span><br />
                <br />
                <span>Authority: {item.authority || 'Unknown'}</span><br />
                <br />
                <span>Year: {item.year || 'Unknown'}</span><br />
                <br />
                <span>Valid: {item.valid || 'Unknown'}</span><br />
                <br />
                <span>Synonyms: {item.synonyms || 'Unknown'}</span><br />
                <br />
                <span>Common names: {item.common_names || 'Unknown'}</span><br />
                <br />
                <span>Distribution: {item.distribution_raw || 'Unknown'}</span><br />
                <br />
                <span>Notes: {item.notes || 'Unknown'}</span><br />
                <br />
                <span>Diagnosis: {item.diagnosis_raw || 'Unknown'}</span><br />
                <br />
                <span>Type specimens: {item.type_specimens || 'Unknown'}</span><br />
                <br />
                <span>Media links: {item.media_links || 'Unknown'}</span><br />
                <br />
                <span>Identifier: {item.identifier || 'Unknown'}</span><br />
                <br />
                <span>Etymology: {item.etymology || 'Unknown'}</span><br />
                <br />
                <span>Catalog Number: {item.catalog_number || 'Unknown'}</span><br />
                <br />
                <span>External ID: {item.external_id || 'Unknown'}</span><br />
                <br />
